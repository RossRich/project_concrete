<!-- <div class="uk-container2 uk-container-center dev-container-order-correct">
    ...
    <? form('call_manger');?>
        <ul class="uk-grid uk-grid-width-medium-1-1 uk-grid-width-large-1-3 uk-grid-width-small-1-1 dev-order-li-correct" data-uk-grid-margin>
            <li>
                <div class="uk-flex">
                    <i class="uk-icon-user uk-icon-large dev-img-ico-correct"></i>
                    <div class="input-item">
                        <label for="name" class="dev-order-label">Ваше Имя</label>
                        <input type="text" name="form[name]" class="dev-order-input" required>
                    </div>
                </div>
            </li>
            <li>
                <div class="uk-flex">
                    ...
                    <div class="input-item">
                        ...
                        <input type="tel" name="form[tel]" class="dev-order-input" required>
                    </div>
                </div>
            </li>
            <li>
