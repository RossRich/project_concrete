                ...
                <ul class="uk-grid uk-grid-collapse uk-grid-width-small-1-1 uk-grid-width-medium-1-1 uk-grid-width-large-1-2">
                    <li>
                        <div class="agree_text">
                            ...
                            <p>
                                Наши поставщики: ООО "Оникс", ООО "БетонСтройСервис", ООО "Юг Логистик", ООО "Стройкомплекс", ООО "Строй Лидер", ООО "Химком", ООО "Хиталком", ООО "СтройПодряд-Юг", ООО "Фирма Автодеталь".
                            </p>
                            <p>
