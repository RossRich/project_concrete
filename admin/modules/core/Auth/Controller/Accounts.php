...
class Accounts extends \Cockpit\Controller {
    ...
    public function create() {
        ...
        $uid       = null;
        $account   = ["user"=>"", "email"=>"", "active"=>1, "group"=>"agent", "i18n"=>$this->app->helper("i18n")->locale];
    ...
    public function save() {
        ...
        if ($data = $this->param("account", false)) {
            ...
            if (!is_dir(COCKPIT_DOCS_ROOT."/uploads/".$data["_id"])) mkdir(COCKPIT_DOCS_ROOT."/uploads/".$data["_id"]);
