...
<div class="uk-grid" data-ng-controller="account" data-uk-margin ng-cloak>
    ...
    <div class="uk-width-medium-2-4">
        ...
        <div class="uk-panel app-panel-box docked uk-text-center">
            ...
            <h2 class="uk-text-truncate">@@ account.name @@ @@ account.secondname @@ @@ account.lastname @@</h2>
        </div>
            ...
            <div class="uk-grid" data-uk-margin>
                ...
                <div class="uk-width-medium-1-1">
                    ...
                    <form class="uk-form" data-ng-submit="save()" data-ng-show="account">
                        ...
                        <div class="uk-form-row">
                            <label class="uk-text-small">@lang('Lastname')</label>
                            <input class="uk-width-1-1 uk-form-large" type="text" data-ng-model="account.lastname">
                        </div>
                        ...
                        <div class="uk-form-row">
                            <label class="uk-text-small">@lang('Secondname')</label>
                            <input class="uk-width-1-1 uk-form-large" type="text" data-ng-model="account.secondname">
                        </div>
                        ...
                        <div class="uk-form-row">
                            <label class="uk-text-small">@lang('Phone')</label>
                            <input class="uk-width-1-1 uk-form-large" type="text" data-ng-model="account.phone">
                        </div>
                        
                        <div class="uk-form-row">
                            <label class="uk-text-small">@lang('Photo')</label>
                            <input type="text" media-path-picker="*" caption="" class="ng-pristine ng-untouched ng-valid ng-scope"  data-ng-model="account.photo" style="display: none;">
                        </div>
    ...
    <div class="uk-width-medium-1-4 uk-form">
        ...
        @if(($app["user"]["group"]=="admin" OR $app["user"]["group"]=="superagent") AND @$account["_id"]!=$app["user"]["_id"])
        <div class="uk-form-row">
            <div class="uk-margin">
                <div class="uk-form-controls uk-margin-small-top">
                    <input type="checkbox" data-ng-model="account.public" /> @lang("Active")
                </div>
            </div>
        </div>
        @endif
        ...
        <div class="uk-form-row">
            <div class="uk-margin">
                <div class="uk-form-controls uk-margin-small-top">
                    <input type="checkbox" data-ng-model="account.thebest" /> @lang("The best")
                </div>
            </div>
        </div>
        @endif
