@if(count($collections))
    ...
    <div class="uk-margin-bottom">
        <span class="uk-button-group">
            ...
            @end
            <a class="uk-button app-button-secondary uk-button-small" href="@route('/collections')" title="@lang('Show all collections')" data-uk-tooltip="{pos:'bottom'}">@lang('Show all collections')</a>
        </span>
    </div>
