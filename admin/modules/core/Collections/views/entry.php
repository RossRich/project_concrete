        ...
        <div class="uk-grid" data-uk-grid-margin>
            ...
            <div class="uk-width-medium-3-4">
                <div class="app-panel">
                    ...
                    <ul class="uk-tab" data-uk-tab="{connect:'#tabs'}" data-ng-show="collection.tabs.length">
                        <li><a href="" class="uk-hidden"></a></li>
                        <li data-ng-repeat="tab in collection.tabs" data-ng-class="{'uk-active':$first}"><a href="#">@@ tab.name @@</a></li>
                        <li data-ng-class="{'uk-hidden':!fieldsInArea('main').length}"><a href="" data-ng-class="{'uk-hidden':!fieldsInArea('main').length}">Другие параметры</a></li>
                    </ul>

                    <ul id="tabs" class="uk-switcher uk-margin">
                        <li class="uk-hidden"></li>
                        <li data-ng-repeat="tab in collection.tabs" data-ng-class="{'uk-active':$first}">
                            
                            <div class="uk-grid">
                                <div class="uk-margin-bottom uk-width-@@ field.width @@" data-ng-repeat="field in fieldsInArea(tab.name)">

                                    <label class="uk-text-small" data-ng-class="{'uk-text-bold':field.strong}">
                                    ...
                                    <contentfield data-class="uk-width-1-1 uk-form-large" options="@@ field @@" ng-model="entry[getFieldname(field)]"></contentfield>
                        ...
                        <li data-ng-class="{'uk-active':!collection.tabs.length}">
                            <div class="uk-grid">
                                <div class="uk-margin-bottom uk-width-@@ field.width @@" data-ng-repeat="field in fieldsInArea('main')">
                                    <label class="uk-text-small" data-ng-class="{'uk-text-bold':field.strong}">
                                        <span ng-if="field.localize"><i class="uk-icon-comments-o"></i></span>
                                        @@ (field.label || field.name) | uppercase @@
                                        <span ng-if="field.required">*</span>
            ...
            <div class="uk-width-medium-1-4">
                <div class="uk-grid">
                    <div class="uk-margin-bottom uk-width-@@ field.width @@" data-ng-repeat="field in fieldsInArea('side')">
